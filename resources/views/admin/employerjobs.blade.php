...
@section('navbar')
    @extends('partials.navbar', ['activePage2' => 'employer', 'activeJobs' => 'employerjobs'])
@endsection
        ...
        <div class="container">
            <nav aria-label="breadcrumb animated fadeIn">
                <ol class="breadcrumb text-uppercase" style="margin-top:30px; margin-bottom:40px;">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('admin.employerlist') }}">Daftar Pemberi Kerja</a></li>
                    <li class="breadcrumb-item text-body active" aria-current="page">Daftar Lowongan = {{ $employer->id }}.{{ $employer->name }}</li>
                </ol>
            </nav>
...
<script>
    function loadJobs() {
        ...
        $.ajax({
            url: "{{ route('admin.getemployerjobs', $employer->id) }}",
            type: "GET",
            data: {
                title: title,
                category: category,
