...
@section('navbar')
    @extends('partials.navbar', ['activePage' => 'history', 'activeJobs' => 'history'])
@endsection
    ...
    <div class="container-xxl py-5" style="margin-top : -60px;">
        ...
        <nav aria-label="breadcrumb animated fadeIn">
                <ol class="breadcrumb text-uppercase" style=" margin-bottom:40px;">
                    ...
                    <li class="breadcrumb-item text-body active" aria-current="page">Riwayat Melamar</li>
                </ol>
            </nav>
            <div class="row g-0 gx-5 align-items-end">
                <div class="col-lg-6" style="margin-bottom:-30px;">
                    <div class="text-start mx-auto mb-5 wow slideInLeft" data-wow-delay="0.1s">
                        <h1 class="mb-3">Riwayat Lowongan</h1>
        ...
        $(document).ready(function () {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    const lamarans = data.lamaran;
                    let jobsHtml = '';
                    jobs.forEach(job => {
                        const lamaran = lamarans.find(l => l.job_id == job.id);
                        jobsHtml += `<a href="/jobs/detail/${job.id}">
                     ...
                     <button class="dropdown-item text-danger" data-bs-toggle="modal" data-bs-target="#modal-hapus-${job.id}">
                                    ...
                                    <div class="modal fade tes" id="modal-hapus-${job.id}" tabindex="-1" aria-labelledby="modalHapusLabel-${job.id}" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <form action="/jobs/history/delete/${lamaran.id}" method="POST" class="modal-content">
