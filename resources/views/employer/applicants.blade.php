...
@section('navbar')
    @extends('partials.navbar', ['activePage' => 'jobs', 'activePage2' => 'employer', 'activeJobs' => 'applicants'])
@endsection
        ...
        <div class="container">
            <nav aria-label="breadcrumb animated fadeIn">
                <ol class="breadcrumb text-uppercase" style="margin-bottom:40px;">
                    ...
                    @if($from == 'detail')
                        <li class="breadcrumb-item"><a href="{{ route('employer.jobdetail', $job->id) }}">Detail Lowongan</a>
                        </li>
                    @endif
                    <li class="breadcrumb-item text-body active" aria-current="page">Daftar Pelamar</li>
                </ol>
            </nav>
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    data.forEach(lamarans => {
                        rows += `
                            <a href="/employer/myjobs/applicants/detail/${lamarans.id}?from=${from}">
